define([	'underscore',
    ...
    function(_,
        ...
        GameScene.prototype.attachAssets = function() {
            ...
            require([	'backdrops/fond',
                    'entities/taupe'
                    ],
                function(	Fond, Taupe) {

                    that.fond = new Fond();
                    that.taupe = new Taupe();
                    deferred.resolve();
        ...
        GameScene.prototype.attachListeners = function() {
            ...
            TAPTAUPE.canvas.element.addEventListener('click', publishPlayerClick);
        ...
        GameScene.prototype.removeListeners = function() {
           TAPTAUPE.canvas.element.removeEventListener('click', publishPlayerClick);
        ...
        GameScene.prototype.render = function() {
            ...
            TAPTAUPE.stage.addChild(this.fond);
            TAPTAUPE.stage.addChild(this.taupe);
            TAPTAUPE.stage.update();
